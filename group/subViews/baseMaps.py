...
class RetrieveUpdateDestroyBaseMapView(RetrieveUpdateDestroyAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        """delete a BaseMap"""
        return super(RetrieveUpdateDestroyBaseMapView, self).delete(
            request, *args, **kwargs
        )
    ...
    def get(self, request, *args, **kwargs):
        """Retrieve a BaseMap"""
        return super(RetrieveUpdateDestroyBaseMapView, self).get(
            request, *args, **kwargs
        )
    ...
    def put(self, request, pk, format=None):
        ...
        vp_serializer = BaseMapSerializer(
        ...
        if "picto" in request.data:
            ...
            picto = updatePicto(
                request.data["picto"], ImageBox(left=0, top=0, right=976, bottom=310)
            )
...
class BaseMapListCreateView(ListCreateAPIView):
    queryset = Base_map.objects.all()
    serializer_class = BaseMapSerializer
    model = Base_map
    ...
    def get(self, request, *args, **kwargs):
        ...
        return super(BaseMapListCreateView, self).get(request, *args, **kwargs)
    ...
    def post(self, request, *args, **kwargs):
        ...
        if "picto" in request.data:
            ...
            if vp_serializer.is_valid():
                ...
                transaction.rollback()
                return Response(
                    vp_serializer.errors, status=status.HTTP_400_BAD_REQUEST
                )

        else:
            return Response(
                " 'picto' field is required", status=status.HTTP_400_BAD_REQUEST
            )
...
class SetPrincipalBaseMap(APIView):
    ...
    @swagger_auto_schema(
        ...
        request_body=openapi.Schema(
            type=openapi.TYPE_OBJECT, properties={"id": openapi.TYPE_INTEGER}
        ),
        responses={200: ""},
        tags=["Base map"],
    )
