...
from .views import ListVectorProviderView, searchVectorProvider, VectorProviderDetailView, ListStyleView, \
    vectorProviderWithStyleDetailView, ListCustomStyle, StyleDetailView
