    ...
    def save(self, *args, **kwargs):
        ...
        if self.pk:
            ...
            if previousStyle.qml_file != self.qml_file:
                ...
                responseUpdateStyle = updateStyle(self.provider_vector_id.id_server, self.provider_vector_id.path_qgis,
                ...
                responsePicto = getImageFromSymbologieOfLayer(self.provider_vector_id.id_server,
                                                              self.provider_vector_id.path_qgis, self.name, path)
            ...
            responseAddStyle = addStyleQMLFromStringToLayer(self.provider_vector_id.id_server,
